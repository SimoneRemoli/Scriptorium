            ...
            while(status)
            {
                ...
                if(rs!=null)
                {
                    if (indice == 1) {
                        ...
                        if (!rs.next()) {
                            System.out.println("Non ci sono prestiti locali in corso.");
                        } else {
                            do {
                                System.out.println("----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
                    ...
                    if(indice==2)
                    {
                        if (!rs.next()) { //altrimenti avanza il cursore e me salta il primo elemento
                            System.out.println("Non ci sono prestiti in corso di libri richiesti in altre biblioteche.");
                        } else {
